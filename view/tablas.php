...
switch ($filtro) {
    case 'nombre':
        $sql = "SELECT Distinct * FROM tbl_alumno inner join tbl_clase ORDER BY nom_alu";
        break;
    case 'apellido1_alu':
        $sql = "SELECT * FROM tbl_alumno inner join tbl_clase ORDER BY apellido1_alu";
        break;
    case 'apellido2_alu':
        $sql = "SELECT * FROM tbl_alumno inner join tbl_clase ORDER BY apellido2_alu";
        break;
    case 'dni_alum':
        $sql = "SELECT * FROM tbl_alumno inner join tbl_clase ORDER BY dni_alum";
        break;
    case 'email_alum':
        $sql = "SELECT * FROM tbl_alumno inner join tbl_clase ORDER BY email_alum";
        break;
    case 'telf_alum':
        $sql = "SELECT * FROM tbl_alumno inner join tbl_clase ORDER BY telf_alum";
        break;
    case 'codi_clase':
